...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (rcaptchaSystem && rcaptchaDate) {
            ...
            .setDescription(`<:carpi:1040649840394260510> | Bu sistem <t:${parseInt(rcaptchaDate.date / 1000)}:R> önce açılmış!`)

...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const sunucuSahibi = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1040649840394260510> | Sunucu sahibini susturamazsın, nasıl kaldıracaksın?")

        const kendiniSusturma = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1040649840394260510> | Kendi timeoutunu kaldıramazsın, zaten yok.")

        const botuSusturma = new EmbedBuilder()
            .setColor("Red")
            .setDescription("<:carpi:1040649840394260510> | Benim susturmam yok ki? Susturamazsında zaten :call_me:")
        ...
        const logMessage = new EmbedBuilder()
            .setColor("Green")
            .setTitle("<:tik:1039607067729727519> | Bir Üye'nin Susturması Kaldırıldı!")
        ...
        const basarili = new EmbedBuilder()
            .setColor("Green")
            .setDescription(`<:tik:1039607067729727519> | ${kullanıcı} adlı üyenin susturmasını kaldırdım.`)
